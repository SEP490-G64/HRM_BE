...
class ProductIngredientRepositoryTest {
  ...
  @Mock private ProductIngredientRepository productIngredientRepository; // Mock repository
  ...
  void shouldSaveProductIngredient() {
    ...
    when(productIngredientRepository.save(any(ProductIngredientEntity.class)))
