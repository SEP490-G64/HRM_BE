...
class StaffProductIngredientControllerTest {
    ...
    void getByPaging_ShouldReturnListOfProductIngredients() {
        ...
        // Act
        ResponseEntity<BaseOutput<List<ProductIngredient>>> response = productIngredientController.getByPaging(0, 20, "id");
    ...
    void getById_ShouldReturnProductIngredient() {
        ...
        // Act
        ResponseEntity<BaseOutput<ProductIngredient>> response = productIngredientController.getById(1L);
    ...
    void create_ShouldReturnCreatedProductIngredient() {
        ...
        // Act
        ResponseEntity<BaseOutput<ProductIngredient>> response = productIngredientController.create(ingredient);
    ...
    void update_ShouldReturnUpdatedProductIngredient() {
        ...
        // Act
        ResponseEntity<BaseOutput<ProductIngredient>> response = productIngredientController.update(1L, ingredient);
    ...
    void getById_ShouldReturnBadRequest_WhenIdIsInvalid() {
        ...
        assertEquals(HrmConstant.ERROR.REQUEST.INVALID_PATH_VARIABLE, response.getBody().getErrors().get(0));
    }

    @Test
    void create_ShouldReturnBadRequest_WhenIngredientIsNull() {
        // Act
        ResponseEntity<BaseOutput<ProductIngredient>> response = productIngredientController.create(null);
    ...
    void update_ShouldReturnBadRequest_WhenIdIsInvalid() {
        // Act
        ResponseEntity<BaseOutput<ProductIngredient>> response = productIngredientController.update(-1L, new ProductIngredient());
