...
public class MailUtil {
  ...
  public SimpleMailMessage constructResetTokenEmail(
    ...
    String message =
        "Vui lòng nhấp vào liên kết dưới đây để đặt lại mật khẩu của bạn cho Ứng dụng Quản lý kho"
            + " Hệ thống nhà thuốc:\n"
            + fullPath
            + "\n\n"
            + "Sau khi nhấp vào liên kết, bạn sẽ được hướng dẫn để thiết lập mật khẩu mới. Xin lưu"
            + " ý rằng liên kết này sẽ hết hạn sau 1 giờ để đảm bảo an toàn cho tài khoản của"
            + " bạn.\n"
