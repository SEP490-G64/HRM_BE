...
public class UnitConversionImpl implements UnitConversionService {
  ...
  @Override
  public BigDecimal convertToUnit(Long productId, Long baseUnitId, BigDecimal quantity, UnitOfMeasurement targetUnit, Boolean toBaseUnit) {
    ...
    UnitConversionEntity conversion =
            unitConversionRepository.findByProductIdAndLargerUnitIdAndSmallerUnitId(
                    productId, baseUnitId, targetUnit.getId()).orElse(null);
