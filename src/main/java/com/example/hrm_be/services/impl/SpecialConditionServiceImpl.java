...
public class SpecialConditionServiceImpl implements SpecialConditionService {
    ...
    public SpecialCondition getById(Long id) {
        return Optional.ofNullable(id)
                .flatMap(e -> specialConditionRepository.findById(e).map(b -> specialConditionMapper.toDTO(b)))
                .orElse(null);
    }
    ...
    public SpecialCondition create(SpecialConditionCreateRequest specialCondition) {
        ...
        if (specialCondition.getProductId() != null) {
            ...
            if (product == null) {
                throw new HrmCommonException("Product not found with id: " + specialCondition.getProductId());
            }
        } else {
            product = null;
        }
    ...
    public SpecialCondition update(SpecialConditionUpdateRequest specialCondition) {
        SpecialConditionEntity oldSpecialConditionEntity = specialConditionRepository.findById(specialCondition.getId()).orElse(null);
