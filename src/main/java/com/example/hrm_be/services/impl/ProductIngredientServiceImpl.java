...
public class ProductIngredientServiceImpl implements ProductIngredientService {
  @Autowired private ProductIngredientRepository ingredientRepository;
  @Autowired private ProductIngredientMapper ingredientMapper;
  ...
  public ProductIngredient update(ProductIngredient ingredient) {
    ProductIngredientEntity oldIngredientEntity =
        ingredientRepository.findById(ingredient.getId()).orElse(null);
