...
public class StaffInventoryCheckDetailsController {
    ...
    protected ResponseEntity<BaseOutput<List<InventoryCheckDetails>>> getByPaging(
        ...
        Page<InventoryCheckDetails> InventoryCheckDetailsPage = inventoryCheckDetailsService.getByPaging(page, size, sortBy);
    ...
    protected ResponseEntity<BaseOutput<InventoryCheckDetails>> create(
            @RequestBody @NotNull(message = "error.request.body.invalid") InventoryCheckDetailsCreateRequest InventoryCheckDetails) {
        ...
        InventoryCheckDetails createdInventoryCheckDetails = inventoryCheckDetailsService.create(InventoryCheckDetails);
    ...
    protected ResponseEntity<BaseOutput<InventoryCheckDetails>> update(
            ...
            @RequestBody @NotNull(message = "error.request.body.invalid") InventoryCheckDetailsUpdateRequest InventoryCheckDetails) {
        // Validate the path variable ID
        if (id <= 0 || id == null) {
            BaseOutput<InventoryCheckDetails> response =
                    BaseOutput.<InventoryCheckDetails>builder()
        ...
        InventoryCheckDetails updateInventoryCheckDetails = inventoryCheckDetailsService.update(InventoryCheckDetails);
