...
public class StaffProductCategoryController {
    ...
    protected ResponseEntity<BaseOutput<List<ProductCategory>>> getByPaging(
        ...
        Page<ProductCategory> categoryPage = productCategoryService.getByPagingByKeyword(page, size, sortBy, keyword);
    ...
    protected ResponseEntity<BaseOutput<ProductCategory>> create(
            @RequestBody @NotNull(message = "error.request.body.invalid") ProductCategory productCategory) {
